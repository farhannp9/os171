...
//print its value, address, *ultimate_pointer, **ultimate_pointer and ***ultimate_pointer 
	printf ("ultimate_pointer val=%p, adr=%p, *ultimate_pointer=%p, **ultimate_pointer=%p, ***ultimate_pointer=%c\n", ultimate_pointer, &ultimate_pointer, *ultimate_pointer, **ultimate_pointer, ***ultimate_pointer);
}
